            ...
            .then((invite) => {
                interaction.reply({
                    embeds: [
                        new EmbedBuilder()
                        .setColor(color)
                        .setAuthor({ name: `${interaction.client.user.username} Activities `, iconURL:`${interaction.client.user.avatarURL({ dynanic: true })}` })

                            .setDescription(
                                `**- Link to join the activity**: [Link](${invite.url})`
                            ),
                    ],
                });
            })
